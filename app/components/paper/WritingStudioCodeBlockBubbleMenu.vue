...
import { useTipTapCodeBlockLanguages } from "~/composables/writing/extensions/useTipTapCodeBlockLowlightExtension";
...
const { t } = useI18n();
const codeBlockLanguages = useTipTapCodeBlockLanguages();
