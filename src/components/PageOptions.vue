    ...
    <div class="mxm-page-options-container">
      <TForm label-align="left">
        ...
        >
          ...
          >
            <TRadioButton value="landscape">
              <Icon class="icon-rotate" name="page" />
              {{ t('page.orientation.landscape') }}
            </TRadioButton>
            <TRadioButton value="portrait">
              <Icon name="page" />
              {{ t('page.orientation.portrait') }}
            </TRadioButton>
          </TRadioGroup>
        </TFormItem>
        <TFormItem v-if="page.layout === 'page'" :label="t('page.size.text')">
          <TSelect
            :popup-props="{
        ...
        <TFormItem :label="t('pageOptions.margin.text')" name="name">
          <div>
