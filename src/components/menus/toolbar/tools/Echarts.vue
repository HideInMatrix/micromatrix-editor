      ...
      <div v-if="dialogVisible" class="mxm-echarts-container">
        <div class="mxm-echarts-header">
          <TRadioGroup
            ...
            default-value="0"
          >
            <TRadioButton :value="0">{{
              t('tools.echarts.setting')
            }}</TRadioButton>
            <TRadioButton :value="1">{{
        ...
        >
          ...
          <div class="mxm-echarts-settting">
            <TForm label-align="top">
              ...
              <TFormItem v-if="baseConfig.config.seriesType === 'line'">
                <!--平滑折线-->
                <TCheckbox
                  v-if="baseConfig.config.seriesType === 'line'"
                  v-model="baseConfig.config.smooth"
                  >{{ t('tools.echarts.set.smooth') }}</TCheckbox
                >
              </TFormItem>
              <TFormItem>
                <!--图例-->
                <TCheckbox v-model="baseConfig.config.legend">{{
